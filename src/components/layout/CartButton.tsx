      ...
      <TooltipTrigger asChild>
        <Link href="/cart">
          <Button 
            variant="ghost" 
            size="icon" 
            className="relative group bg-accent hover:bg-hover border border-border transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-primary/20 w-10 h-10 sm:w-11 sm:h-11"
          >
            <ShoppingBag className="h-4 w-4 sm:h-5 sm:w-5 text-primary group-hover:text-hover transition-colors duration-300" />
