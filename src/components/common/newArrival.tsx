      ...
      <section className="py-12 md:py-16 lg:py-24 bg-background relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex justify-center items-center py-12">
            ...
            <span className="ml-3 text-foreground font-medium">Loading new arrivals...</span>
          </div>
        </div>
      </section>
    );
    ...
    return (
      <section className="py-12 md:py-16 lg:py-24 bg-background relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-lg text-foreground py-12 font-medium">No new arrivals available at the moment.</p>
                  ...
                  <Card className="overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-2 hover:border-primary/30 bg-card/80 backdrop-blur-sm h-full">
                    ...
                    <CardContent className="p-4 md:p-6 bg-card">
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        <span className="font-bold text-lg md:text-xl text-primary">{formatPrice(product.price)}</span>
                        {product.comparePrice && product.comparePrice > product.price && (
                      ...
                      <div className="mb-4 min-h-[1.5rem] flex justify-center">
                        <span className="text-xs font-medium text-primary bg-primary/20 px-3 py-1 rounded-full shadow-sm flex items-center gap-1">
